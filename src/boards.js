...
const inactivityTimeout = process.env.TIMEOUT || (process.env.NODE_ENV === 'test' ? 3600 : 60)
const pauseTimeout = process.env.PAUSE_TIMEOUT || (process.env.NODE_ENV === 'test' ? 40 : 20)
